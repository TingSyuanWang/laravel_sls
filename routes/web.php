...
Route::get('campustour/step3', 'CampusTourStep3Controller@index')->name('campustour.step3')->middleware('url');
Route::post('campustour/step3savedata', 'CampusTourStep3Controller@store')->middleware('url');
Route::get('campustour/step4', 'CampusTourStep4Controller@index')->name('campustour.step4')->middleware('url');
Route::post('campustour/step4savedata', 'CampusTourStep4Controller@store')->middleware('url');
...
Route::get('ambassador/step3', 'AmbassadorStep3Controller@index')->name('ambassador.step3')->middleware('url');
Route::post('ambassador/step3savedata', 'AmbassadorStep3Controller@store')->middleware('url');
Route::get('ambassador/step4', 'AmbassadorStep4Controller@index')->name('ambassador.step4')->middleware('url');
Route::post('ambassador/step4savedata', 'AmbassadorStep4Controller@store')->middleware('url');
