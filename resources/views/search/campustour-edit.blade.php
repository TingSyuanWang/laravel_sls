                    ...
                    <div class="col-md-12">
                        <div class="portlet light portlet-fit ">
                            <div class="portlet-body">
                                {!! Form::model($campustourFormData, ['method'=>'PATCH', 'action'=>['SearchController@campustourUpdate', $campustourFormData->id]]) !!}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                {!! Form::text('ambassadorDate', $campustourFormData['serviceContent'], ['class' => 'form-control input-lg', 'readonly']) !!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
